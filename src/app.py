...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        if (
            ...
            self.signal1 = 1.0  # sensor 1 detects all sand
        ...
        if (
            ...
            self.signal2 = 1.0  # sensor 2 detects all sand
        ...
        if (
            ...
            self.signal3 = 1.0  # sensor 3 detects all sand
...
class Game(Widget):
    ...
    def update(self, dt):
        ...
        )  # playing the action from our AI
        scores.append(brain.score())  # store score of action
        rotation = action2rotation[
            action
        ]  # convert action played (0,1,2) into rotation angle
